...
const MessageWrapper = React.memo<MessageWrapperProps>(({
  message, config, uiConfig, previousMessageComplete, onMessageComplete,
  previousMessage, nextMessage, onVisibilityChange, isNextVisible
}) => {
...
const ChatComponent: React.FC<ChatComponentProps> = ({ config, uiConfig = {} }) => {
  ...
  return (
    <div
      ...
      style={{ width: `${ui.containerWidth}px`, height: `${ui.containerHeight}px`, backgroundColor: ui.backgroundColor }}
    >
      <div
