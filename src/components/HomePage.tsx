  ...
  return (
    <div className="min-h-screen font-sans" style={{ background: BG, color: TEXT }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, background: "rgba(250,250,247,0.92)", backdropFilter: "blur(14px)", borderBottom: `1px solid ${BORDER}`, height: 64 }}
        ...
        <button onClick={onLogin} style={{ fontSize: 14, fontWeight: 500, padding: "8px 20px", borderRadius: 999, border: "none", cursor: "pointer", background: LIME, color: TEXT, transition: "background 0.15s", display: "inline-flex", alignItems: "center", gap: 6 }}
